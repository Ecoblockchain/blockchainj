...
import org.blockchainj.wallet.listeners.AbstractWalletEventListener;
...
/**
 * A class that exposes relevant blockchain stuff as JavaFX bindable properties.
 */
public class BlockchainUIModel {
    ...
    public BlockchainUIModel() {
    }

    public BlockchainUIModel(Wallet wallet) {
        setWallet(wallet);
    }
