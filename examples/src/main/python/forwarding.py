...
# Change this to point to where you have a copy of the blockchainj.jar
sys.path.append(r"/path/to/blockchainj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = org.blockchainj.params.TestNet3Params.get()
