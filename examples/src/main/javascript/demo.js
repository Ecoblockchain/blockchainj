// This file shows how to use blockchainj from Javascript.
// To run, grab the blockchainj bundled JAR and then do something like this:
//
//   jjs -cp blockchainj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp blockchainj-0.12-bundled.jar
//
...
//
//   jjs -cp blockchainj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And blockchainj is a threaded library. This means you
