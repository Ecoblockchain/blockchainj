...
import static org.blockchainj.core.Coin.CENT;
import static org.blockchainj.core.Coin.COIN;
import static org.blockchainj.core.Coin.SATOSHI;
import static org.blockchainj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.BCH.noCode();
    ...
    @Test
    public void mBCHRounding() throws Exception {
    ...
    @Test
    public void uBCHRounding() throws Exception {
    ...
    public void standardCodes() throws Exception {
        assertEquals("BCH 0.00", MonetaryFormat.BCH.format(Coin.ZERO).toString());
        assertEquals("mBCH 0.00", MonetaryFormat.MBCH.format(Coin.ZERO).toString());
        assertEquals("µBCH 0", MonetaryFormat.UBCH.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dBCH 0", MonetaryFormat.UBCH.code(1, "dBCH").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        assertEquals("0", MonetaryFormat.UBCH.noCode().shift(0).format(Coin.ZERO).toString());
        // Ensure that inserting a code after codes are wiped, works
        assertEquals("dBCH 0", MonetaryFormat.UBCH.noCode().code(1, "dBCH").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("BCH 0.00", MonetaryFormat.BCH.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 BCH", MonetaryFormat.BCH.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("BCH@0.00", MonetaryFormat.BCH.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UBCH.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MBCH.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MBCH.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MBCH.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MBCH.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MBCH.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MBCH.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UBCH.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UBCH.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UBCH.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UBCH.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UBCH.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UBCH.parse("-1.0"));
