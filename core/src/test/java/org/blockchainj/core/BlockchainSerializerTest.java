...
public class BlockchainSerializerTest {
    ...
    public void testAddr() throws Exception {
        ...
        // the actual data from https://en.blockchain.it/wiki/Protocol_specification#addr
    ...
    public void testBlockchainPacketHeaderTooShort() {
        new BlockchainSerializer.BlockchainPacketHeader(ByteBuffer.wrap(new byte[] { 0 }));
    }

    @Test(expected = ProtocolException.class)
    public void testBlockchainPacketHeaderTooLong() {
        ...
        new BlockchainSerializer.BlockchainPacketHeader(ByteBuffer.wrap(wrongMessageLength));
    }
