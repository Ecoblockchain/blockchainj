...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        // copied verbatim from https://en.blockchain.it/wiki/Protocol_specification#Network_address
        ...
        String reserialized = Utils.HEX.encode(pa.unsafeBlockchainSerialize());
        assertEquals(reserialized,fromSpec );
    }

    @Test
    public void testBlockchainSerialize() throws Exception {
        ...
        assertEquals("000000000000000000000000000000000000ffff7f000001208d",
                Utils.HEX.encode(pa.blockchainSerialize()));
    }
}
