...
import org.blockchainj.testing.InboundMessageQueuer;
import org.blockchainj.testing.TestWithNetworkConnections;
...
public class PeerTest extends TestWithNetworkConnections {
    ...
    public void badMessage() throws Exception {
        ...
        serializer.serialize("inv", new InventoryMessage(PARAMS) {
            @Override
            public void blockchainSerializeToStream(OutputStream stream) throws IOException {
                // Add some hashes.
