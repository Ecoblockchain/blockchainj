...
import org.blockchainj.utils.BlockFileLoader;
...
import static org.blockchainj.core.Coin.FIFTY_COINS;
...
public abstract class AbstractFullPrunedBlockChainTest {
    ...
    public void testGetOpenTransactionOutputs() throws Exception {
        ...
        // Create blockchain spend of 1 BCH.
    ...
    public void testUTXOProviderWithWallet() throws Exception {
        ...
        // Create 1 BCH spend to a key in this wallet (to ourselves).
        ...
        // Create another spend of 1/2 the value of BCH we have available using the wallet (store coin selector).
        ...
        // The availbale balance should be the 0 (as we spent the 1 BCH that's pending) and estimated should be 1/2 - fee BCH
        assertEquals("Available balance is incorrect", Coin.ZERO, wallet.getBalance(Wallet.BalanceType.AVAILABLE));
