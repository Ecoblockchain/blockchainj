...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Blockchain protocol.
 * See {@link org.blockchainj.script.Script} for details. Also provides a method to convert them to a string.
 */
