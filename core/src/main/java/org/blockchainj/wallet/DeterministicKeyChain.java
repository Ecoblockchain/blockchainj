/*
 * Copyright 2014 The blockchainj developers.
 ...
 * <a href="https://github.com/blockchain/bips/blob/master/bip-0032.mediawiki">BIP 32 standard</a>, as implemented by
 * {@link org.blockchainj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.blockchainj.crypto.MnemonicCode},
 ...
 * {@link org.blockchainj.crypto.DeterministicKey#serializePubB58(org.blockchainj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.blockchainj.crypto.DeterministicKey#deserializeB58(org.blockchainj.crypto.DeterministicKey, String, org.blockchainj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.blockchainj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.blockchainj.crypto.DeterministicHierarchy} and
 * {@link org.blockchainj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from blockchainj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.blockchainj.crypto.DeterministicKey)}
     ...
     * @see org.blockchainj.wallet.MarriedKeyChain
     */
