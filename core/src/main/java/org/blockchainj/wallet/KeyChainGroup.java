...
/**
 * <p>A KeyChainGroup is used by the {@link org.blockchainj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.blockchainj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.blockchainj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.blockchainj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
