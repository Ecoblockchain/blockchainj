...
import org.blockchain.protocols.payments.Protos.PaymentDetails;
...
import org.blockchainj.wallet.KeyChain.KeyPurpose;
import org.blockchainj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.blockchainj.wallet.Wallet#getBalance()} - the fees required
     ...
     * is how mining is incentivized in later years of the Blockchain system when inflation drops. It also provides
     ...
     * when choosing which transactions to add to a block. Note that, to keep this equivalent to Blockchain Core
     * definition, a kilobyte is defined as 1000 bytes, not 1024.</p>
     */
    public Coin feePerKb = Context.get().getFeePerKb();

    /**
     * <p>Requires that there be enough fee for a default Blockchain Core to at least relay the transaction.
    ...
    /**
     * If not null, the {@link org.blockchainj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
