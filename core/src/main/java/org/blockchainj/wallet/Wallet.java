...
package org.blockchainj.wallet;
...
import org.blockchain.protocols.payments.Protos.*;
import org.blockchainj.core.listeners.*;
import org.blockchainj.core.AbstractBlockChain;
import org.blockchainj.core.Address;
import org.blockchainj.core.BlockChain;
import org.blockchainj.core.BloomFilter;
import org.blockchainj.core.Coin;
import org.blockchainj.core.Context;
import org.blockchainj.core.ECKey;
import org.blockchainj.core.FilteredBlock;
import org.blockchainj.core.InsufficientMoneyException;
import org.blockchainj.core.Message;
import org.blockchainj.core.NetworkParameters;
import org.blockchainj.core.Peer;
import org.blockchainj.core.PeerFilterProvider;
import org.blockchainj.core.PeerGroup;
import org.blockchainj.core.ScriptException;
import org.blockchainj.core.Sha256Hash;
import org.blockchainj.core.StoredBlock;
import org.blockchainj.core.Transaction;
import org.blockchainj.core.TransactionBag;
import org.blockchainj.core.TransactionBroadcast;
import org.blockchainj.core.TransactionBroadcaster;
import org.blockchainj.core.TransactionConfidence;
import org.blockchainj.core.TransactionInput;
import org.blockchainj.core.TransactionOutPoint;
import org.blockchainj.core.TransactionOutput;
import org.blockchainj.core.UTXO;
import org.blockchainj.core.UTXOProvider;
import org.blockchainj.core.UTXOProviderException;
import org.blockchainj.core.Utils;
import org.blockchainj.core.VarInt;
import org.blockchainj.core.VerificationException;
import org.blockchainj.core.TransactionConfidence.*;
import org.blockchainj.crypto.*;
import org.blockchainj.script.*;
import org.blockchainj.signers.*;
import org.blockchainj.utils.*;
import org.blockchainj.wallet.Protos.Wallet.*;
import org.blockchainj.wallet.WalletTransaction.*;
import org.blockchainj.wallet.listeners.KeyChainEventListener;
import org.blockchainj.wallet.listeners.ScriptsChangeEventListener;
import org.blockchainj.wallet.listeners.WalletChangeEventListener;
import org.blockchainj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.blockchainj.wallet.listeners.WalletCoinsSentEventListener;
import org.blockchainj.wallet.listeners.WalletEventListener;
import org.blockchainj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * of the Blockchain protocol.</p>
 *
 * <p>To learn more about this class, read <b><a href="https://blockchainj.github.io/working-with-the-wallet">
 ...
 * other objects, see the <a href="https://blockchainj.github.io/getting-started">Getting started</a> tutorial
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.blockchainj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    // Dead:     Transactions that we believe will never confirm get moved here, out of pending. Note that Blockchain
     ...
     * {@link org.blockchainj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.blockchainj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.blockchainj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.blockchainj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.blockchainj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.blockchainj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.blockchainj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.blockchainj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.blockchainj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.blockchainj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.blockchainj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.blockchainj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.blockchainj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of blockchainj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.blockchainj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.blockchainj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.blockchainj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.blockchainj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.blockchainj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.blockchainj.crypto.KeyCrypter,
     ...
     * {@link org.blockchainj.crypto.KeyCrypterScrypt}.
     *
    ...
    private void processTxFromBestChain(Transaction tx, boolean forceAddToPool) throws VerificationException {
        ...
        if (isDeadCoinbase) {
            ...
            // we could. Blockchain Core nodes on the network have deleted the dependent transactions from their mempools
        ...
        for (TransactionInput input : tx.getInputs()) {
            ...
            if (result == TransactionInput.ConnectionResult.ALREADY_SPENT) {
                if (fromChain) {
                    ...
                    log.warn("{}: {}", tx.getHash(), Utils.HEX.encode(tx.unsafeBlockchainSerialize()));
                    Transaction other = output.getSpentBy().getParentTransaction();
                    log.warn("{}: {}", other.getHash(), Utils.HEX.encode(other.unsafeBlockchainSerialize()));
                }
     ...
     * of {@link org.blockchainj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.blockchainj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    /**
     * Returns the amount of blockchain ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of blockchain ever sent via output. If an output is sent to our own wallet, because of change or
    ...
    public static class SendResult {
        /** The Blockchain transaction message that moves the money. */
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.blockchainj.signers.TransactionSigner.MissingSignatureException}
     ...
     *
     * @param address The Blockchain address to send the money to.
     ...
     * @throws ExceededMaxTransactionSize if the resultant transaction is too big for Blockchain to process.
    ...
    /**
     * Thrown if the resultant transaction is too big for Blockchain to process. Try breaking up the amounts of value.
     */
    ...
    public void completeTx(SendRequest req) throws InsufficientMoneyException {
        ...
        try {
            ...
            // Check size.
            final int size = req.tx.unsafeBlockchainSerialize().length;
    ...
    private boolean adjustOutputDownwardsForFee(Transaction tx, CoinSelection coinSelection, Coin feePerKb,
        ...
        final int size = tx.unsafeBlockchainSerialize().length + estimateBytesForSigning(coinSelection);
            ...
            for (Sha256Hash blockHash : oldBlockHashes) {
                for (TxOffsetPair pair : mapBlockTx.get(blockHash)) {
                    ...
                    if (tx.isCoinBase()) {
                        ...
                        // this coinbase tx. Some can just go pending forever, like the Blockchain Core. However we
                        // can do our best.
    ...
    public BloomFilter getBloomFilter(int size, double falsePositiveRate, long nTweak) {
        ...
        try {
            ...
            for (TransactionOutPoint point : bloomOutPoints)
                filter.insert(point.unsafeBlockchainSerialize());
            return filter;
        } finally {
            endBloomFilterCalculation();
        }
    ...
    public FeeCalculation calculateFee(SendRequest req, Coin value, List<TransactionInput> originalInputs,
        ...
        while (true) {
            ...
            // If change is < 0.01 BCH, we will need to have at least minfee to be accepted by the network
            ...
            if (change.signum() > 0) {
                ...
                if (req.ensureMinRequiredFee && changeOutput.isDust()) {
                    ...
                    size += changeOutput.unsafeBlockchainSerialize().length + VarInt.sizeOf(req.tx.getOutputs().size()) - VarInt.sizeOf(req.tx.getOutputs().size() - 1);
            ...
            size += req.tx.unsafeBlockchainSerialize().length;
     ...
     * sending transactions to the Blockchain network by default. Some sendCoins methods let you specify a broadcaster
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.blockchainj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.blockchainj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
    ...
    private Transaction rekeyOneBatch(long timeSecs, @Nullable KeyParameter aesKey, List<Transaction> others, boolean sign) {
        ...
        try {
            ...
            checkState(rekeyTx.unsafeBlockchainSerialize().length < Transaction.MAX_STANDARD_TX_SIZE);
            return rekeyTx;
