...
import org.blockchainj.protocols.channels.*;
import org.blockchainj.store.*;
import org.blockchainj.wallet.*;
import org.slf4j.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV blockchainj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit blockchainj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing blockchainj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.blockchainj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the blockchainj website for further details.
     */
    ...
    protected void startUp() throws Exception {
        ...
        try {
            ...
            // Initiate Blockchain network objects (block store, blockchain and peer group)
