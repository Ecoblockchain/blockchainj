...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.blockchainj.core.PeerFilterProvider}s, a merged
 * {@link org.blockchainj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.blockchainj.core.PeerGroup} class internally.</p>
 *
