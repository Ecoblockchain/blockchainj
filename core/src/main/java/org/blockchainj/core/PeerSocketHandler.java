...
import org.blockchainj.net.AbstractTimeoutHandler;
import org.blockchainj.net.MessageWriteTarget;
 ...
 * {@link org.blockchainj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
    ...
    private BlockchainSerializer.BlockchainPacketHeader header;
    ...
    public int receiveBytes(ByteBuffer buff) {
        checkArgument(buff.position() == 0 &&
                buff.capacity() >= BlockchainSerializer.BlockchainPacketHeader.HEADER_LENGTH + 4);
        try {
     ...
     * called automatically by {@link org.blockchainj.net.NioClient} or
     * {@link org.blockchainj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
