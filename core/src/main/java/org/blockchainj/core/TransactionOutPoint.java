...
public class TransactionOutPoint extends ChildMessage {
    ...
    // This is not part of blockchain serialization. It points to the connected transaction.
    Transaction fromTx;
     ...
     * For P2SH scripts you can use {@link #getConnectedRedeemData(org.blockchainj.wallet.KeyBag)} and then get the
     * key from RedeemData.
