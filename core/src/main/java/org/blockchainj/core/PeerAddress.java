...
import static org.blockchainj.core.Utils.uint32ToByteStreamLE;
import static org.blockchainj.core.Utils.uint64ToByteStreamLE;
import static com.google.common.base.Preconditions.checkNotNull;

/**
 * <p>A PeerAddress holds an IP address and port number representing the network location of
 * a peer in the Blockchain P2P network. It exists primarily for serialization purposes.</p>
 * 
...
public class PeerAddress extends ChildMessage {
    ...
    public PeerAddress(InetAddress addr, int port) {
        this(addr, port, NetworkParameters.ProtocolVersion.CURRENT.getBlockchainProtocolVersion());
    }
     ...
     * are default for Blockchain mainnet.
     */
     ...
     * Blockchain mainnet, version number is default for the given parameters.
     */
    ...
    public PeerAddress(InetSocketAddress addr) {
        this(addr.getAddress(), addr.getPort(), NetworkParameters.ProtocolVersion.CURRENT.getBlockchainProtocolVersion());
    }
     ...
     * Protocol version is the default for Blockchain.
     */
    public PeerAddress(String hostname, int port) {
        this.hostname = hostname;
        this.port = port;
        this.protocolVersion = NetworkParameters.ProtocolVersion.CURRENT.getBlockchainProtocolVersion();
        this.services = BigInteger.ZERO;
    }
