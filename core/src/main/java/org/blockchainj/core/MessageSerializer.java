...
public abstract class MessageSerializer {
     ...
     */
    public abstract BlockchainSerializer.BlockchainPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException, UnsupportedOperationException;

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link BlockchainSerializer#deserializeHeader}.
     */
    public abstract Message deserializePayload(BlockchainSerializer.BlockchainPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException, UnsupportedOperationException;
