...
/**
 * A collection of various utility methods that are helpful for working with the Blockchain protocol.
 * To enable debug logging from the library, run with -Dblockchainj.logging=true on your command line.
 */
public class Utils {

    /** The string that prefixes all text messages signed using Blockchain keys. */
    public static final String BLOCKCHAIN_SIGNED_MESSAGE_HEADER = "Blockchain Signed Message:\n";
    public static final byte[] BLOCKCHAIN_SIGNED_MESSAGE_HEADER_BYTES = BLOCKCHAIN_SIGNED_MESSAGE_HEADER.getBytes(Charsets.UTF_8);
     ...
     *
     * <p>Blockchain only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.
     ...
     *
     * <tt><p>[24] "Blockchain Signed Message:\n" [message.length as a varint] message</p></tt>
     */
    public static byte[] formatMessageForSigning(String message) {
        try {
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            bos.write(BLOCKCHAIN_SIGNED_MESSAGE_HEADER_BYTES.length);
            bos.write(BLOCKCHAIN_SIGNED_MESSAGE_HEADER_BYTES);
