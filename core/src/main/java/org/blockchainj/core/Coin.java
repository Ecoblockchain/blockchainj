...
/**
 * Represents a monetary Blockchain value. This class is immutable.
 */
public final class Coin implements Monetary, Comparable<Coin>, Serializable {

    /**
     * Number of decimals for one Blockchain. This constant is useful for quick adapting to other coins because a lot of
     * constants derive from it.
     */
    public static final int SMALLEST_UNIT_EXPONENT = 8;

    /**
     * The number of satoshis equal to one blockchain.
     */
    ...
    /**
     * 0.01 Blockchains. This unit is not really used much.
     */
    public static final Coin CENT = COIN.divide(100);

    /**
     * 0.001 Blockchains, also known as 1 mBCH.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 Blockchains, also known as 1 µBCH or 1 uBCH.
     */
    public static final Coin MICROCOIN = MILLICOIN.divide(1000);

    /**
     * A satoshi is the smallest unit that can be transferred. 100 million of them fit into a Blockchain.
     */
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.BCH.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.BCH.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in BCH.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" BCH
     * </p>
     */
