...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * the FP rate higher, due to <a href="https://groups.google.com/forum/#!msg/blockchainj/Ys13qkTwcNg/9qxnhwnkeoIJ">
     * various complexities</a> there are still ways a remote peer can deanonymize the users wallet. This is why the
     * FP rate is chosen for performance rather than privacy. If a future version of blockchainj fixes the known
     ...
     * <a href="https://github.com/blockchain/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     *
     ...
     * {@link org.blockchainj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.blockchainj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.blockchainj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.blockchainj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.blockchainj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.blockchainj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.blockchainj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.blockchainj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.blockchainj.core.Peer#ping()}.
     */
    ...
    /**
     * When true (the default), PeerGroup will attempt to connect to a Blockchain node running on localhost before
     * attempting to use the P2P network. If successful, only localhost will be used. This makes for a simple
     * and easy way for a user to upgrade a blockchainj based app running in SPV mode to fully validating security.
     */
