...
/**
 * <p>Methods to serialize and de-serialize messages to the Blockchain network format as defined in
 * <a href="https://en.blockchain.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.blockchainSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class BlockchainSerializer extends MessageSerializer {
    private static final Logger log = LoggerFactory.getLogger(BlockchainSerializer.class);
    ...
    /**
     * Constructs a BlockchainSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     * @param parseRetain      retain the backing byte array of a message for fast reserialization.
     */
    public BlockchainSerializer(NetworkParameters params, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("BlockchainSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.blockchainSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Blockchain protocol message has the following format.
        //
        ...
        //
        // Blockchain Core ignores garbage before the magic header bytes. We have to do the same because
        // sometimes it sends us stuff that isn't part of any message.
        seekPastMagicBytes(in);
        BlockchainPacketHeader header = new BlockchainPacketHeader(in);
     ...
     */
    @Override
    public BlockchainPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new BlockchainPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link BlockchainSerializer#deserializeHeader}.
     */
    @Override
    public Message deserializePayload(BlockchainPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class BlockchainPacketHeader {
        ...
        public BlockchainPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
