...
public class VersionMessage extends Message {
    ...
    /**
     * User-Agent as defined in <a href="https://github.com/blockchain/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     * Blockchain Core sets it to something like "/Satoshi:0.9.1/".
     */
     ...
     * See <a href="https://github.com/blockchain/bips/blob/master/bip-0037.mediawiki#extensions-to-existing-messages">BIP 37</a>.
     */
    public boolean relayTxesBeforeFilter;

    /** The version of this library release, as a string. */
    public static final String BLOCKCHAINJ_VERSION = "0.14.3";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/blockchainj:" + BLOCKCHAINJ_VERSION + "/";
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        // Note that the Blockchain Core doesn't do anything with these, and finding out your own external IP address
    ...
    @Override
    public void blockchainSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.blockchainSerialize(buf);
            // Their address.
            theirAddr.blockchainSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for blockchainj
     * users might look like "/blockchainj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/blockchainj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://github.com/blockchain/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.
     *
