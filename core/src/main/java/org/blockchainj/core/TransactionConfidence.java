 ...
 *
 * <p>TransactionConfidence is updated via the {@link org.blockchainj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link org.blockchainj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link org.blockchainj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link org.blockchainj.core.TransactionConfidence#getConfidenceType()}
     ...
     * On average there is supposed to be a new block every 10 minutes, but the actual rate may vary. Blockchain Core
     ...
     * and so on. This information is useful for {@link org.blockchainj.wallet.CoinSelector} implementations to risk analyze
