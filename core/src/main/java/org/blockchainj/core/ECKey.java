...
import org.blockchain.NativeSecp256k1;
import org.blockchain.NativeSecp256k1Util;
import org.blockchain.Secp256k1Context;
import org.blockchainj.wallet.Protos;
 ...
 *
 * <p>ECKey also provides access to Blockchain Core compatible text message signing, as accessible via the UI or JSON-RPC.
 ...
 * are encoded using ASN.1/DER inside the Blockchain protocol.</p>
 *
...
public class ECKey implements EncryptableItem {
    ...
    // The parameters of the secp256k1 curve that Blockchain uses.
    ...
    /**
     * Construct an ECKey from an ASN.1 encoded private key. These are produced by OpenSSL and stored by Blockchain
    ...
    /**
     * Output this ECKey as an ASN.1 encoded private key, as understood by OpenSSL or used by Blockchain Core
     * in its wallet storage format.
     * @throws org.blockchainj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the Blockchain protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * href="https://github.com/blockchain/bips/blob/master/bip-0062.mediawiki#Low_S_values_in_signatures">BIP62</a>.
         */
         ...
         * the same message. However, we dislike the ability to modify the bits of a Blockchain transaction after it's
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Blockchain protocol, they are
     * usually encoded using ASN.1 format, so you want {@link org.blockchainj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Blockchain protocol, they are
     * usually encoded using DER format, so you want {@link org.blockchainj.core.ECKey.ECDSASignature#encodeToDER()}
    ...
    /**
     * Signs a text message using the standard Blockchain messaging signing format and returns the signature as a base64
     * encoded string.
     *
    ...
    /**
     * Given an arbitrary piece of text and a Blockchain-format message signature encoded in base64, returns an ECKey
     * containing the public key that was used to sign it. This can then be compared to the expected public key to
     * determine if the signature was correct. These sorts of signatures are compatible with the Blockchain-Qt/blockchaind
     * format generated by signmessage/verifymessage RPCs and GUI menu options. They are intended for humans to verify
     * their communications with each other, hence the base64 format and the fact that the input is text.
     *
     * @param message Some piece of human readable text.
     * @param signatureBase64 The Blockchain-format message signature in base64
     ...
     * @throws org.blockchainj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
    ...
    /**
     * Exports the private key in the form used by Blockchain Core's "dumpprivkey" and "importprivkey" commands. Use
     * the {@link org.blockchainj.core.DumpedPrivateKey#toString()} method to get the string.
     *
     ...
     * blockchains controlled by the private key) you can use this method to check when you *encrypt* a wallet that
