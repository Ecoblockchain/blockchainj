 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the Blockchain serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link org.blockchainj.core.BlockChain#getChainHead()}
     * or perhaps {@link org.blockchainj.core.BlockChain#getBestChainHeight()} which will run in constant time and
    ...
    /**
     * Get the {@link org.blockchainj.core.NetworkParameters} of this store.
