 ...
 * so you can use {@link #calculateBalanceForAddress(org.blockchainj.core.Address)} to quickly look up
 * the quantity of blockchains controlled by that address.</p>
 */
