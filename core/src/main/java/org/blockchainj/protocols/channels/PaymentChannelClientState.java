 ...
 * <i>receiving party</i>. Although the underlying Blockchain protocol is capable of more complex relationships than that,
...
public abstract class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelV1ClientState#editContractSendRequest(org.blockchainj.wallet.Wallet.SendRequest)}.
