...
import org.blockchainj.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelV1ClientState extends PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelV1ClientState#editContractSendRequest(org.blockchainj.core.Wallet.SendRequest)}.
    ...
    public synchronized void initiate(@Nullable KeyParameter userKey) throws ValueOutOfRangeException, InsufficientMoneyException {
        ...
        // relies on the fact that since Blockchain 0.8 time locked transactions are non-final. This will need to change
    ...
    public synchronized void provideRefundSignature(byte[] theirSignature, @Nullable KeyParameter userKey)
        ...
        TransactionSignature theirSig = TransactionSignature.decodeFromBlockchain(theirSignature, true);
