...
import static org.blockchainj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
/**
 * <p>This class, a concrete extension of {@link BCHFormat}, is distinguished in that each
 * instance formats and by-default parses all Blockchain monetary values in units of a single
 ...
 * custom pattern using either the {@link BCHFormat.Builder#localizedPattern} or {@link BCHFormat.Builder#localizedPattern} methods, as described in the documentation for the {@link BCHFormat.Builder}
 * class.<ol>
 *
 * <p>A more detailed explanation, including examples, is in the documentation for the
 * {@link BCHFormat} class, and further information beyond that is in the documentation for the
...
public final class BCHFixedFormat extends BCHFormat {
     ...
     *  thet same value expressed in blockchains. */
    private final int scale;

    /** Constructor */
    protected BCHFixedFormat(
     ...
     * the denomination is milliblockchains, this method will return the value <code>3</code>.  As
     ...
     *  the denomination is milliblockchains, this method will return the value <code>3</code>.  */
    @Override
     ...
     * denomination is milliblockchains, then this method will return <code>"mBCH"</code>,
     * assuming the default base currency-code is not overridden using a
     * {@link BCHFormat.Builder}.  */
     ...
     * milliblockchains, this method by default returns <code>"₥฿"</code>, depending on the
     * locale.  */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof BCHFixedFormat)) return false;
        BCHFixedFormat other = (BCHFixedFormat)o;
