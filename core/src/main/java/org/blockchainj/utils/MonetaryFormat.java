...
import org.blockchainj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    public static final MonetaryFormat BCH = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mBCH denomination. */
    public static final MonetaryFormat MBCH = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µBCH denomination. */
    public static final MonetaryFormat UBCH = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 Blockchain. */
    public static final String CODE_BCH = "BCH";
    /** Currency code for base 1/1000 Blockchain. */
    public static final String CODE_MBCH = "mBCH";
    /** Currency code for base 1/1000000 Blockchain. */
    public static final String CODE_UBCH = "µBCH";
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for Blockchain
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard BCH notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes[0] = CODE_BCH;
        this.codes[3] = CODE_MBCH;
        this.codes[6] = CODE_UBCH;
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link org.blockchainj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.blockchainj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
