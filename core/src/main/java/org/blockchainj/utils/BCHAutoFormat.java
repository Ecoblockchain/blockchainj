...
/**
 * <p>This class, a concrete extension of {@link BCHFormat}, is distinguished by its
 * accommodation of multiple denominational units as follows:
 *
 * <p>When formatting Blockchain monetary values, an instance of this class automatically adjusts
 ...
 *
 * <p>When parsing <code>String</code> representations of Blockchain monetary values, instances of
 ...
 * BCHFormat} class, and further information beyond that is in the documentation for the {@link
...
public final class BCHAutoFormat extends BCHFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "BCH". */
        CODE {
    ...
    /** Constructor */
    protected BCHAutoFormat(Locale locale, Style style, int fractionPlaces) {
    ...
    /**
     * Calculate the appropriate denomination for the given Blockchain monetary value.  This
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof BCHAutoFormat)) return false;
