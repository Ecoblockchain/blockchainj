 ...
 */
public abstract class AbstractBlockchainNetParams extends NetworkParameters {
    /**
     * Scheme part for Blockchain URIs.
     */
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        return version.getBlockchainProtocolVersion();
    }

    @Override
    public BlockchainSerializer getSerializer(boolean parseRetain) {
        return new BlockchainSerializer(this, parseRetain);
    }

    @Override
    public String getUriScheme() {
        return BLOCKCHAIN_SCHEME;
    }
