...
/**
 * Network parameters used by the blockchainj unit tests (and potentially your own). This lets you solve a block using
 * {@link org.blockchainj.core.Block#solve()} by setting difficulty to the easiest possible.
 */
public class UnitTestParams extends AbstractBlockchainNetParams {
